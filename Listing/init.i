...
#line 2 "..\\..\\User\\exDev\\src\\init.c"
#line 3 "..\\..\\User\\exDev\\src\\init.c"
#line 4 "..\\..\\User\\exDev\\src\\init.c"
...
void NVIC_of_All(void)
{
	...
	UART2_NVIC_Config(1, 0);
    IIC2_NVIC_Config(0, 0);
	Timer4_NVIC_Config(1, 1);	
}

void PWM_INIT(void)					
{
	 
	TIM3_PWM_PA6_PA7_PB0_PB1_Config(20000, 72);

	TIM2_PWM_PA0_PA1_PA2_PA3_Config(20000, 72);
}
...
void IIC2_Config(void)
{
	...
	I2C_GeneralCallCmd(((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x5800)),ENABLE);

	I2C_ITConfig( ((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x5800)), ((uint16_t)0x0200) | ((uint16_t)0x0400) | ((uint16_t)0x0100), ENABLE );
}
...
void Exit_Config(void)
{
	...
	RCC_APB2PeriphClockCmd(((uint32_t)0x00000040) | ((uint32_t)0x00000001),ENABLE);
  ...
  GPIO_EXTILineConfig(((uint8_t)0x04), ((uint8_t)0x0A) | ((uint8_t)0x09) | ((uint8_t)0x08)); 
  EXTI_InitStructure.EXTI_Line = ((uint32_t)0x00400) | ((uint32_t)0x00200) | ((uint32_t)0x00100);
