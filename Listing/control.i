#line 1 "..\\..\\User\\Alogrisem\\src\\Control.c"
#line 1 "..\\..\\User\\Alogrisem\\inc\\Control.h"
...
#line 6 "..\\..\\User\\Alogrisem\\inc\\Control.h"
...
void IOIIC_IMU_GPS_GET(struct IMU_Parameter para);


#line 2 "..\\..\\User\\Alogrisem\\src\\Control.c"
#line 3 "..\\..\\User\\Alogrisem\\src\\Control.c"
#line 1 "..\\..\\User\\BSP_Init\\inc\\timer.h"



#line 5 "..\\..\\User\\BSP_Init\\inc\\timer.h"
...
#line 23 "..\\..\\User\\BSP_Init\\inc\\timer.h"
...
#line 4 "..\\..\\User\\Alogrisem\\src\\Control.c"
#line 1 "..\\..\\User\\BSP_Init\\inc\\bsp_SysTick.h"



#line 5 "..\\..\\User\\BSP_Init\\inc\\bsp_SysTick.h"

void SysTick_Init(void);
void Delay_us(volatile u32 nTime);


#line 5 "..\\..\\User\\Alogrisem\\src\\Control.c"
#line 1 "..\\..\\User\\exDev\\inc\\init.h"
...
#line 6 "..\\..\\User\\exDev\\inc\\init.h"

#line 8 "..\\..\\User\\exDev\\inc\\init.h"
#line 9 "..\\..\\User\\exDev\\inc\\init.h"
#line 1 "..\\..\\User\\exDev\\inc\\bsp_spi_flash.h"



#line 5 "..\\..\\User\\exDev\\inc\\bsp_spi_flash.h"

#line 20 "..\\..\\User\\exDev\\inc\\bsp_spi_flash.h"
...
#line 10 "..\\..\\User\\exDev\\inc\\init.h"
#line 1 "..\\..\\User\\BSP_Init\\inc\\bsp_adc.h"




#line 6 "..\\..\\User\\BSP_Init\\inc\\bsp_adc.h"

#line 15 "..\\..\\User\\BSP_Init\\inc\\bsp_adc.h"

void ADC1_Init(void);
void ADC_Fliter(void);


extern volatile uint16_t fliterValue[];


#line 11 "..\\..\\User\\exDev\\inc\\init.h"
#line 1 "..\\..\\User\\BSP_Init\\inc\\bsp_led.h"



#line 5 "..\\..\\User\\BSP_Init\\inc\\bsp_led.h"
...
#line 12 "..\\..\\User\\exDev\\inc\\init.h"
#line 13 "..\\..\\User\\exDev\\inc\\init.h"
#line 1 "..\\..\\User\\BSP_Init\\inc\\uart.h"



#line 5 "..\\..\\User\\BSP_Init\\inc\\uart.h"
...
#line 14 "..\\..\\User\\exDev\\inc\\init.h"
#line 1 "..\\..\\User\\BSP_Init\\inc\\encode.h"



#line 5 "..\\..\\User\\BSP_Init\\inc\\encode.h"
...
#line 15 "..\\..\\User\\exDev\\inc\\init.h"
#line 1 "..\\..\\User\\BSP_Init\\inc\\IOI2C.h"
#line 4 "..\\..\\User\\BSP_Init\\inc\\IOI2C.h"
...
#line 18 "..\\..\\User\\BSP_Init\\inc\\IOI2C.h"

#line 26 "..\\..\\User\\BSP_Init\\inc\\IOI2C.h"
...
#line 16 "..\\..\\User\\exDev\\inc\\init.h"

#line 1 "..\\..\\User\\exDev\\inc\\IMU.h"




#line 6 "..\\..\\User\\exDev\\inc\\IMU.h"
...
#line 18 "..\\..\\User\\exDev\\inc\\init.h"
#line 19 "..\\..\\User\\exDev\\inc\\init.h"
#line 1 "..\\..\\User\\exDev\\inc\\AHRSREG.h"



#line 33 "..\\..\\User\\exDev\\inc\\AHRSREG.h"

#line 67 "..\\..\\User\\exDev\\inc\\AHRSREG.h"
      
#line 20 "..\\..\\User\\exDev\\inc\\init.h"
...
#line 6 "..\\..\\User\\Alogrisem\\src\\Control.c"
...
#line 7 "..\\..\\User\\Alogrisem\\src\\Control.c"
#line 1 "..\\..\\User\\BSP_Init\\inc\\GPIOLIKE51.h"
...
#line 20 "..\\..\\User\\BSP_Init\\inc\\GPIOLIKE51.h"

#line 28 "..\\..\\User\\BSP_Init\\inc\\GPIOLIKE51.h"
...
#line 8 "..\\..\\User\\Alogrisem\\src\\Control.c"
...
unsigned char RC_CONL_BOX[128];
static unsigned char rC_fLAG = 0x00;
void MOTION_UART_GET(unsigned char data)
{
	
	static unsigned char rC_cNT = 0;
	if (data == 0x5a)								
	{
		rC_fLAG |= 0X80;					
		RC_CONL_BOX[rC_cNT++] = data;	
	}
	else if(data == 0xa5)						
	{
		if (rC_fLAG & 0X80)				
...
#line 135 "..\\..\\User\\Alogrisem\\src\\Control.c"

volatile unsigned char rec_data[88];
...
float cpg_para4[12];				
short int cpg_para2[12];		

void CPGParameterUpdate(void)
{
	union FLOAT2CHAR temp;
	unsigned char i = 0, j;
	unsigned char b_len = 2;
	
	if (b_len == 4)
	{
		for (j = 2; j < rec_data[0] - 4; j += 4, i++)
		{
			temp.byte[0] = rec_data[j];
			temp.byte[1] = rec_data[j + 1];
			temp.byte[2] = rec_data[j + 2];
			temp.byte[3] = rec_data[j + 3];
			cpg_para4[i] = temp.num;
		}	
	}
	if (b_len == 2)
	{
		for (j = 2; j < rec_data[0] - 2; j += 2, i++)
		{
			temp.byte[0] = rec_data[j];
			temp.byte[1] = rec_data[j + 1];
			cpg_para2[i] = temp.num;
		}
	}
}
...
#line 291 "..\\..\\User\\Alogrisem\\src\\Control.c"

volatile unsigned char rec_char_data[88];
...
void FrameCharGet(unsigned char data)
{
	...
	{
		rec_char_flag |= 0x01;								
		rec_char_data[rec_char_index] = data;						
		rec_char_index++;																
	}
	else if (data == 'a')															
	{
		if (rec_char_flag & 0x01)						
		{
			*((volatile unsigned long *)((((((((uint32_t)0x40000000) + 0x10000) + 0x1000)+12) & 0xF0000000)+0x2000000+(((((((uint32_t)0x40000000) + 0x10000) + 0x1000)+12) &0xFFFFF)<<5)+(13<<2)))) = 0;
			rec_char_flag &= ~0x02;						
			rec_char_flag |= 0x03;						
	...
	else
	{
		...
		if (rec_char_index == 2 && (rec_char_flag & 0x03))
		{
...
float y_axis, x_axis, z_axis;
float parameter[6];
void CharDataProcess(void)
{
	unsigned char index;
	unsigned short int _4th, _3th, _2nd, _1st;
	unsigned char i;
	index = 4;
	...
	Motor_Speed = (float)((_4th + _3th + _2nd + _1st) - 2000)/1000;		
	...
	_2nd = (rec_char_data[index + 2] - '0')*   10;		
	_1st = (rec_char_data[index + 3] - '0');					
	Motor_Log_degree_12 = (float)(_4th + _3th + _2nd + _1st) - 2000;		
	...
	_2nd = (rec_char_data[index + 2] - '0')*   10;		
	_1st = (rec_char_data[index + 3] - '0');					
	Motor_Log_degree_13 = (float)(_4th + _3th + _2nd + _1st) - 2000;	
	...
	_2nd = (rec_char_data[index + 2] - '0')*   10;		
	_1st = (rec_char_data[index + 3] - '0');					
	Motor_Amplitude_degree[0] = (float)(_4th + _3th + _2nd + _1st) - 2000;	
	...
	_2nd = (rec_char_data[index + 2] - '0')*   10;		
	_1st = (rec_char_data[index + 3] - '0');					
	Motor_Amplitude_degree[1] = (float)(_4th + _3th + _2nd + _1st) - 2000;	
	...
	_2nd = (rec_char_data[index + 2] - '0')*   10;		
	_1st = (rec_char_data[index + 3] - '0');					
	Motor_Amplitude_degree[2] = (float)(_4th + _3th + _2nd + _1st) - 2000;	
	...
	_2nd = (rec_char_data[index + 2] - '0')*   10;		
	_1st = (rec_char_data[index + 3] - '0');					
	Motor_Dynamic_Offset_degree[0] = (float)(_4th + _3th + _2nd + _1st) - 2000;	
	...
	_2nd = (rec_char_data[index + 2] - '0')*   10;		
	_1st = (rec_char_data[index + 3] - '0');					
	Motor_Dynamic_Offset_degree[1] = (float)(_4th + _3th + _2nd + _1st) - 2000;	
	...
	_2nd = (rec_char_data[index + 2] - '0')*   10;		
	_1st = (rec_char_data[index + 3] - '0');					
	Motor_Dynamic_Offset_degree[2] = (float)(_4th + _3th + _2nd + _1st) - 2000;
...
void IOIIC_IMU_GPS_GET(struct IMU_Parameter para)
{
    ...
    IICreadBytes(para.devID, para.index, para.num, para.imuArray);
}
