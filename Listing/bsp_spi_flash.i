#line 1 "..\\..\\User\\exDev\\src\\bsp_spi_flash.c"
...
#line 19 "..\\..\\User\\exDev\\src\\bsp_spi_flash.c"
...
#line 42 "..\\..\\User\\exDev\\src\\bsp_spi_flash.c"
...
void SPI_FLASH_Init(void)
{
  ...
  RCC_APB2PeriphClockCmd(((uint32_t)0x00000004) | ((uint32_t)0x00000020), ENABLE);
  ...
  ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->BSRR = ((uint16_t)0x0004);
...
void SPI_FLASH_SectorErase(u32 SectorAddr)
{
  ...
  ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->BRR = ((uint16_t)0x0004);
