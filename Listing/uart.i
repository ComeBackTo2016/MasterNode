#line 1 "..\\..\\User\\BSP_Init\\src\\uart.c"
...
#line 2 "..\\..\\User\\BSP_Init\\src\\uart.c"
...
#line 3 "..\\..\\User\\BSP_Init\\src\\uart.c"
...
#line 4 "..\\..\\User\\BSP_Init\\src\\uart.c"
...
void UART1_PA09_PA10_Config(void)
{
		...
		RCC_APB2PeriphClockCmd(((uint32_t)0x00004000) | ((uint32_t)0x00000004) | ((uint32_t)0x00000001), ENABLE);
...
void UART4_PC10_PC11_Config(void)
{
	...
	USART_InitStructure.USART_HardwareFlowControl = ((uint16_t)0x0000);
	USART_InitStructure.USART_Mode                = ((uint16_t)0x0004) | ((uint16_t)0x0008);
	USART_Init(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4C00)), &USART_InitStructure);
...
void UART5_PC12_PD02_Config(void)
{
	...
	RCC_APB2PeriphClockCmd(((uint32_t)0x00000010) | ((uint32_t)0x00000020) | ((uint32_t)0x00000001), ENABLE);
	...
	USART_InitStructure.USART_HardwareFlowControl = ((uint16_t)0x0000);
	USART_InitStructure.USART_Mode                = ((uint16_t)0x0004) | ((uint16_t)0x0008);
	USART_Init(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x5000)), &USART_InitStructure);
...
{ 
   ...
   ((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800))->DR = (Data & (uint16_t)0x01FF);	 
}

void USART2_SendByte(u16 Data)
{ 
   while (!(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4400))->SR & ((uint16_t)0x0080)));
   ((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4400))->DR = (Data & (uint16_t)0x01FF);	   
}
...
void USART2_SendString(uint8_t *ch)
{
	...
	{		
		...
		USART_SendData(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4400)), *ch);
		ch++;
	}   	
}
...
void USART3_SendByte(u16 Data)
{
   ...
   ((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4800))->DR = (Data & (uint16_t)0x01FF);	 
}
