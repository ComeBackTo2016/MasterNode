...
{	
	...
	if (TIM_GetITStatus(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0800)), ((uint16_t)0x0001)) != RESET)
		...
		cpg_run();
		((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0400))->CCR1 = (uint16_t)(1500 + (2000*theta[0])/3.1415);
		((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0400))->CCR2 = (uint16_t)(1500 + (2000*theta[1])/3.1415);
		((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0400))->CCR3 = (uint16_t)(1500 + (2000*theta[2])/3.1415);
		 	
		Pectoral_CPG_Calculate();
        ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0400))->CCR4 = (uint16_t)(1500 + (2000*Pectoral_Theta[0])/3.1415);
        ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0000))->CCR1= (uint16_t)(1500 + (2000*Pectoral_Theta[1])/3.1415);
...
{
	u16 tsr;
	tsr=((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2C00))->SR;	
	if(tsr&0X0001)
	{
																				
	}				   
	((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2C00))->SR&=~(1<<0);
}
...
{
	u16 tsr;
	tsr=((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3400))->SR;	
	if(tsr&0X0001)
	{
																				
	}				   
	((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3400))->SR&=~(1<<0);
}
...
void USART1_IRQHandler(void)
{
	...
	{ 	
			ch = USART_ReceiveData(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800)));
...
void USART2_IRQHandler(void)
{
	...
	{ 	
			ch = USART_ReceiveData(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4400)));
	} 
}
