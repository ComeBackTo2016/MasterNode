...
static void ADC1_Mode_Config(void)
{
	...
	ADC_InitStructure.ADC_NbrOfChannel = 3;	 								//要转换的通道数目8
	ADC_Init(ADC1, &ADC_InitStructure);
	
	/*配置ADC时钟，为PCLK2的8分频，即9MHz*/
	RCC_ADCCLKConfig(RCC_PCLK2_Div8); 
	/*配置ADC1的通道11为55.	5个采样周期，序列为1 */ 
	ADC_RegularChannelConfig(ADC1, ADC_Channel_10, 1, ADC_SampleTime_55Cycles5);// BAT_V
	ADC_RegularChannelConfig(ADC1, ADC_Channel_11, 2, ADC_SampleTime_55Cycles5);// I_GIG
	ADC_RegularChannelConfig(ADC1, ADC_Channel_12, 3, ADC_SampleTime_55Cycles5);// I_DJ
//	ADC_RegularChannelConfig(ADC1, ADC_Channel_15, 4, ADC_SampleTime_55Cycles5);// T2
//	ADC_RegularChannelConfig(ADC1, ADC_Channel_4 , 5, ADC_SampleTime_55Cycles5);// T3
//	ADC_RegularChannelConfig(ADC1, ADC_Channel_5 , 6, ADC_SampleTime_55Cycles5);// T4
//	ADC_RegularChannelConfig(ADC1, ADC_Channel_12, 7, ADC_SampleTime_55Cycles5);// PVG
//	ADC_RegularChannelConfig(ADC1, ADC_Channel_13, 8, ADC_SampleTime_55Cycles5);// PIG
	/* Enable ADC1 DMA */
