...
static void CAN_Filter_Config(void)
{
    ...
    CAN_FilterInitStructure.CAN_FilterIdHigh= (((u32)0x13f0<<3)&0xFFFF0000)>>16;				
    CAN_FilterInitStructure.CAN_FilterIdLow= (((u32)0x13f0<<3)|CAN_ID_EXT|CAN_RTR_DATA)&0xFFFF; 
//    CAN_FilterInitStructure.CAN_FilterMaskIdHigh= ((0xFFF00000<<3)&0XFFFF0000)>>16;			
//    CAN_FilterInitStructure.CAN_FilterMaskIdLow= ((0xFFF00000<<3)|CAN_ID_EXT|CAN_RTR_DATA)&0xFFFF;
    CAN_FilterInitStructure.CAN_FilterMaskIdHigh= ((0xFFF00000<<3)&0XFFFF0000)>>16;			
    CAN_FilterInitStructure.CAN_FilterMaskIdLow= ((0xFFF00000<<3)|CAN_ID_EXT|CAN_RTR_DATA)&0xFFFF;	
...
{	  
  ...
  TxMessage.ExtId=0x1310;					 //使用的扩展ID
